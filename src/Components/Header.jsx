    ...
    <>
      <nav class="w-full h-20  flex justify-between sticky px-4 items-center lg:px-4">
        <div class="flex font-semibold items-center">
          ...
          <Link class="lg:flex hidden ml-8 mt-[10px] mx-[10px] cursor-pointer items-center">
            Product{" "}
            <svg
        ...
        <div class="lg:flex hidden items-center font-semibold">
          ...
          <h4 class="mt-[10px]">EN</h4>
          <Link class="mt-[10px] mx-[10px] cursor-pointer">Contact Sales</Link>
          <Link class="mt-[10px] mx-[10px] cursor-pointer">Login</Link>
          <button class="lg:flex items-center mt-[10px] px-3.5 py-3.5 bg-blue-500 text-white rounded-3xl">
